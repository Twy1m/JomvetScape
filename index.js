...
const derrota = new Audio('audio/gameover.mp3')
musica.volume = 0.2
...
const points = new Audio('audio/points.mp3')
musica.volume = 0.2
...
function desenhaSobre() {
  ...
  ctx.fillText("Feito por: Matheus Gomes Steingraber", W / 2, 320)
...
function atualiza() {
  ...
  if(estado === ST.JOGO || estado === ST.TRANS){
      musica.play()
  }else{
    musica.pause()
  }
  if(estado === ST.VITORIA){
    win.play()
  }
